...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Generate unique member ID (e.g., MEM-12345)
      ...
      await setDoc(doc(db, "users", user.uid), {
        ...
        role: "MEMBER",
        status: "ACTIVE",
        qrToken: user.uid, // Basic token, can be encrypted later
      ...
      >
        ...
        <div className="relative z-10">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Create your member account</p>
          </div>
          ...
          <p className="text-center text-slate-400 text-sm mt-8">
            ...
            <Link href="/auth/login" className="text-white hover:text-blue-400 transition-colors font-medium">
              Sign in
            </Link>
          </p>
        </div>
